...
export default function CategoriesDetails() {
  ...
  <h2 className='text-2xl font-semibold flex items-center gap-2 text-[#01854C]'><Link to={"/Categories"} className='border-2 border-emerald-500 rounded-full p-1 me-3'><FaArrowLeft /></Link></h2>
    
  <h2 className='mt-10 font-bold w-fit m-auto text-center mb-10 py-2 text-xl border-4 border-transparent border-b-green-600  px-2'>{nameCategoris} Categoris</h2>
  </div>
